...
<h1>Lapsen_001_nimi 4-vuotistarkastuksen tietokokoelma</h1>
<h2>Päivähoidossa täytettävät kentät<span class="kirjaaja">Viimeisin kirjaus 15.4.2011 <a href="#">Etunimi Sukunimi</a></span></h2>
<div class="kirjaus">
Huoltaja on suostunut luovuttamaan nämä tiedot neuvolan työntekijän nähtäväksi.
</div>
...
PÄIVITTÄISTOIMET
  <table width="100%" border="0">
    <tbody><tr>
      ...
      <td width="58%"><input type="checkbox">
      Kyllä
        <input type="checkbox"> 
        Opettelee
        <input type="checkbox">
...
<div class="kirjaus"> 
  <h3>LIIKKUMINEN JA HAMOTTAMINEN </h3>
  <table width="100%" border="0">
    <tbody><tr>
...
<div class="kirjaus"> VAHVUUDET JA HEIKKOUDET LEIKEISSÄ
  <textarea class="add" wrap="soft"></textarea>
<span class="kirjaaja"></span>
</div>


<div class="kirjaus"> VAHVUUDET JA HEIKKOUDET SOSIAALISISSA TAIDOISSA
...
<div class="kirjaus">TERVEISET NEUVOLAAN
<textarea class="add" wrap="soft">Tässä näkyy tallennettu kirjaus, jota voidaan päivittää kokoelman ollessa aktiivinen.
Alakulmaan tallentuu automaattisesti päivämäärä ja kirjaajan nimi.</textarea>
</div>
<div class="kirjaus">
...
<h2>Huoltajan täytettävät kentät<span class="kirjaaja">Viimeisin kirjaus 15.4.2011 <a href="#">Etunimi Sukunimi</a></span></h2>
<div class="kirjaus"><span class="kirjaaja"></span>
</div>
<div class="kirjaus">
  <h3>LIIKKUMINEN JA HAMOTTAMINEN </h3>
  <table width="100%" border="0">
...
<div class="kirjaus"> VAHVUUDET JA HEIKKOUDET SOSIAALISISSA TAIDOISSA
  <div class="add">Tässä näkyy tallennettu kirjaus, jota voidaan päivittää kokoelman ollessa aktiivinen.
Alakulmaan tallentuu automaattisesti päivämäärä ja kirjaajan nimi.</div>
</div>
<div class="kirjaus">TKODIN HUOMIOITA
  <div class="add">Tässä näkyy tallennettu kirjaus, jota voidaan päivittää kokoelman ollessa aktiivinen.
Alakulmaan tallentuu automaattisesti päivämäärä ja kirjaajan nimi.</div>
</div>
