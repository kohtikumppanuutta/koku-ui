...
public class KehitystietoOLD {
  ...
  public KehitystietoOLD(Date pvm, String kuvaus) {
    this.pvm = pvm;
    this.kuvaus = kuvaus;
    this.kentat = new ArrayList<KKSKentta>();
  }
  ...
  public Henkilo getLapsi() {
    return lapsi;
  }

  public void setLapsi(Henkilo lapsi) {
    this.lapsi = lapsi;
  }
