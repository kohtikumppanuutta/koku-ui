...
public final class DemoFactory {
  ...
  public static final String NELI_VUOTIS_TARKASTUS = "4-vuotiaan neuvolatarkastus";
  ...
  // }
  //
  // public static KKSCollection createNewVersion(KKSCollection vanha, String
  // nimi, boolean clean) {
  // KKSCollection k = new KKSCollection("" + ++codeGenerator, vanha, clean, new
  // Date(), new CollectionState(
  // State.ACTIVE), 1);
  // k.setName(nimi);
  ...
  // return new CollectionType(1, VASU,
  // "Sisältää lapsen varhaiskasvatussuunnitelman");
  // }
  //
  // public static CollectionType luoNelivuotisTarkastustype() {
  // return new CollectionType(2, NELI_VUOTIS_TARKASTUS,
  // "Sisältää tiedot lapsen 4-vuotiaan terveystarkastuksesta");
  // }
  //
  ...
  //
  // type.addEntryGroup(new Group(new GroupKey(1, "Huoltaja"),
  // "Päivähoidon asiakasrekisteri"));
  // type.addEntryGroup(new Group(new GroupKey(2, "Päivähoito"),
  // "Päivähoidon asiakasrekisteri"));
  //
  ...
  // KKSCollection k = new KKSCollection("" + codeGenerator, nimi,
  // type.getDescription(), tila, new Date(), 1, type);
  // luoTyhjatKirjaukset(k);
  // return k;
  // }
  //
  // private static void
  // luoVarhaiskasvatusSuunnitelmaPaivahoitoGroup(CollectionType type) {
  // type.addEntryType(luoVapaaTekstientryType("Yhteiset tavoitteet liittyen vuorovaikutukseen",
  // "Kirjataan yhteiset tavoitteet liittyen lapsen vuorovaikutukseen", "",
  // "Päivähoito",
  // "Päivähoidon asiakasrekisteri", "Päivähoito",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_KESKUSTELU),
  // luoclassification(Constants.LUOKITUS_KUMPPANUUS,
  // Constants.LUOKITUS_KOTI)));
  //
  ...
  // "Kuvaa kodin ja päivähoidon yhteistyötä", "Kodin ja päivähoidon yhteistyö",
  // "Päivähoito",
  // "Päivähoidon asiakasrekisteri", "Huoltaja",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_KYSELY),
  // luoclassification(Constants.LUOKITUS_PAIVITTAISET_TOIMINNOT,
  // Constants.LUOKITUS_KOTI)));
  //
  ...
  // "Kirjataan yhteiset tavoitteet liittyen yhteistyöhön", "", "Päivähoito",
  // "Päivähoidon asiakasrekisteri",
  ...
  // "Kirjatut kommentit, havainnot ja tavoitteet", "", "Päivähoito",
  // "Päivähoidon asiakasrekisteri", "Päivähoito",
  // "kommentti, havainto tai tavoite",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_KESKUSTELU),
  // luoclassification(Constants.LUOKITUS_KOMMENTTI, Constants.LUOKITUS_TAVOITE,
  // Constants.LUOKITUS_HAVAINTO)));
  // }
  //
  // private static void
  // luoVarhaiskasvatusSuunnitelmaHuoltajaGroup(CollectionType type) {
  // type.addEntryType(luoVapaaTekstientryType("Miten lapsesi on viihtynyt päivähoidossa",
  // "Kuvaa lapsen hyvinvointia",
  // "Lapsen hyvinvointi", "Päivähoito", "Päivähoidon asiakasrekisteri",
  // "Huoltaja",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_KYSELY),
  ...
  // Constants.LUOKITUS_TERVEYDENTILA,
  ...
  // "Kuvaa lapsen hyvinvointia", "Lapsen hyvinvointi", "Päivähoito",
  // "Päivähoidon asiakasrekisteri", "Huoltaja",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_ARVIO),
  // luoclassification(Constants.LUOKITUS_KOTI,
  // Constants.LUOKITUS_SOSIAALISUUS_JA_TUNNEILMAISU)));
  //
  // type.addEntryType(luoVapaaTekstientryType("Onko lapsellasi pelkoja",
  // "Kuvaa lapsen hyvinvointia",
  // "Lapsen hyvinvointi", "Päivähoito", "Päivähoidon asiakasrekisteri",
  // "Huoltaja",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_ARVIO),
  ...
  // Constants.LUOKITUS_PSYYKKINEN_KEHITYS,
  // Constants.LUOKITUS_FYYSINEN_KEHITYS,
  // Constants.LUOKITUS_KIELI_JA_KOMMUNIKAATIO,
  // Constants.LUOKITUS_HUOLENAIHEET)));
  //
  // type.addEntryType(luoVapaaTekstientryType(
  ...
  // "Huoltaja",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_ARVIO),
  // luoclassification(Constants.LUOKITUS_VAHVUUDET_JA_KIINNOSTUKSET,
  // Constants.LUOKITUS_PAIVITTAISET_TOIMINNOT)));
  //
  // type.addEntryType(luoVapaaTekstientryType("Miten lapsesi toiveet huomioidaan",
  // "Kuvaa lapsen hyvinvointia",
  // "Lapsen hyvinvointi", "Päivähoito", "Päivähoidon asiakasrekisteri",
  // "Huoltaja",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_KYSELY),
  ...
  // "Kirjataan yhteiset tavoitteet liittyen lapsen hyvinvointiin", "",
  // "Päivähoito",
  // "Päivähoidon asiakasrekisteri", "Päivähoito",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_KESKUSTELU),
  // luoclassification(Constants.LUOKITUS_KOTI,
  ...
  // "Kuvaa lapsen vuorovaikutusta", "Vuorovaikutus", "Päivähoito",
  // "Päivähoidon asiakasrekisteri", "Huoltaja",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_KYSELY),
  // luoclassification(Constants.LUOKITUS_PAIVITTAISET_TOIMINNOT,
  // Constants.LUOKITUS_KOTI)));
  ...
  // "Päivähoidon asiakasrekisteri", "Huoltaja",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_ARVIO),
  // luoclassification(Constants.LUOKITUS_LEIKKI,
  // Constants.LUOKITUS_SOSIAALISUUS_JA_TUNNEILMAISU)));
  //
  ...
  // Constants.LUOKITUS_PAIVITTAISET_TOIMINNOT)));
  //
  // type.addEntryType(luoVapaaTekstientryType("Miten lapsesi ilmaisee itseään?",
  // "Kuvaa lapsen vuorovaikutusta",
  // "Vuorovaikutus", "Päivähoito", "Päivähoidon asiakasrekisteri", "Huoltaja",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_ARVIO),
  // luoclassification(Constants.LUOKITUS_SOSIAALISUUS_JA_TUNNEILMAISU,
  ...
  // type.addEntryGroup(new Group(new GroupKey(2, "Päivähoito"),
  // "päivähoidon asiakasrekisteri"));
  // type.addEntryGroup(new Group(new GroupKey(3, "Neuvola"),
  // "potilasrekisteri"));
  //
  // /********************************/
  //
  ...
  // "kuvaa neuvolakäynnin sujumisen",
  ...
  // Constants.LUOKITUS_KIELI_JA_KOMMUNIKAATIO)));
  //
  // type.addEntryType(luoVapaaTekstientryType("Neuvola ohjannut jatkoselvityksiin",
  // "lähetteet", "", "neuvola",
  // "potilasrekisteri", "Neuvola",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_LAHETE),
  // luoclassification(Constants.LUOKITUS_TERVEYDENTILA)));
  //
  // type.addEntryType(luoVapaaTekstientryType("Terveiset päivähoitoon",
  // "neuvolan terveiset päivähoidolle", "",
  // "neuvola", "potilasrekisteri", "Neuvola",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_PALAUTE),
  // luoclassification(Constants.LUOKITUS_TERVEYDENTILA)));
  //
  // type.addEntryType(luoVapaaTekstientryType("Terveiset päivähoitoon",
  // "neuvolan terveiset päivähoidolle", "",
  ...
  // luoclassification(Constants.LUOKITUS_TERVEYDENTILA)));
  //
  // type.addEntryType(luoTekstientryType("Päänympärys",
  // "lapsen päänympärys sentteinä", "Mittaukset", "neuvola",
  // "potilasrekisteri", "Neuvola",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_KAYNTI),
  // luoclassification(Constants.LUOKITUS_MITTAUS)));
  //
  // type.addEntryType(luoTekstientryType("Pituus", "lapsen pituus sentteinä",
  // "Mittaukset", "neuvola",
  // "potilasrekisteri", "Neuvola",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_KAYNTI),
  // luoclassification(Constants.LUOKITUS_MITTAUS)));
  //
  // type.addEntryType(luoTekstientryType("Paino", "lapsen paino kiloina",
  // "Mittaukset", "neuvola", "potilasrekisteri",
  // "Neuvola", luoTyypit(Constants.KEHITYSASIATYYPPI_KAYNTI),
  // luoclassification(Constants.LUOKITUS_MITTAUS)));
  //
  // type.addEntryType(luoMonivalueinenVapaaTekstientryType("Kommentit, havainnot ja tavoitteet",
  // "Kirjatut kommentit, havainnot ja tavoitteet", "", "neuvola",
  // "potilasrekisteri", "Neuvola",
  // "kommentti, havainto tai tavoite",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_KESKUSTELU),
  // luoclassification(Constants.LUOKITUS_KOMMENTTI, Constants.LUOKITUS_TAVOITE,
  ...
  // "Kuvaa perheen kasvatuksellisia keinoja", "", "neuvola",
  ...
  // "Kuvaa perheen nykytilannetta/muutosta", "", "neuvola", "potilasrekisteri",
  // "Huoltaja",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_KYSELY),
  // luoclassification(Constants.LUOKITUS_HUOLENAIHEET)));
  //
  ...
  // "Kuvaa lasta ryhmässä", "",
  // "neuvola", "potilasrekisteri", "Huoltaja",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_KYSELY),
  // luoclassification(Constants.LUOKITUS_HUOLENAIHEET)));
  //
  // type.addEntryType(luoVapaaTekstientryType("Haluan keskustella lisäksi",
  // "Kuvaa keskustelutarpeet", "", "neuvola",
  // "potilasrekisteri", "Huoltaja",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_TOIVE),
  // luoclassification(Constants.LUOKITUS_HUOLENAIHEET)));
  // }
  //
  ...
  // luoTyypit(Constants.KEHITYSASIATYYPPI_ARVIO),
  // luoclassification(Constants.LUOKITUS_MOTORIIKKA,
  // Constants.LUOKITUS_KEHON_HALLINTA,
  // Constants.LUOKITUS_PAIVITTAISET_TOIMINNOT)));
  //
  // type.addEntryType(luoValintaentryType(
  // "Syö siististi",
  ...
  // luovaluet("kyllä", "opettelee", "ei vielä"),
  // luoTyypit(Constants.KEHITYSASIATYYPPI_ARVIO),
  // luoclassification(Constants.LUOKITUS_TARKKAAVAISUUS,
  // Constants.LUOKITUS_PSYYKKINEN_KEHITYS,
  // Constants.LUOKITUS_PAIVITTAISET_TOIMINNOT)));
  //
  // type.addEntryType(luoValintaentryType(
  ...
  // Constants.LUOKITUS_PAIVITTAISET_TOIMINNOT)));
  //
  // type.addEntryType(luoValintaentryType("Päivälepo",
  // "kuvaa päivittäisactionjen sujumista", "Päivittäistoiminnot",
  ...
  // luoTyypit(Constants.KEHITYSASIATYYPPI_ARVIO),
  // luoclassification(Constants.LUOKITUS_FYYSINEN_KEHITYS,
  // Constants.LUOKITUS_KEHON_HALLINTA,
  // Constants.LUOKITUS_LIIKUNANLLISET_TAIDOT,
  // Constants.LUOKITUS_MOTORIIKKA_KARKEA)));
  //
  // type.addEntryType(luoValintaentryType(
  ...
  // Constants.LUOKITUS_MOTORIIKKA_KARKEA)));
  //
  // type.addEntryType(luoValintaentryType("Tunnistaa ja nimeää kehonosia",
  ...
  // luoclassification(Constants.LUOKITUS_PSYYKKINEN_KEHITYS)));
  //
  // type.addEntryType(luoValintaentryType("Piirtää tunnistettavia asioita",
  // "kuvaa psyykkistä kehitystä",
  // "Liikkuminen ja hahmottaminen", "päivähoito",
  // "päivähoidon asiakasrekisteri", "Päivähoito",
  // luovaluet("kyllä", "vaihtelevasti", "ei vielä"),
  ...
  // luoclassification(Constants.LUOKITUS_PSYYKKINEN_KEHITYS)));
  //
  // type.addEntryType(luoValintaentryType("Leikkaa saksilla",
  ...
  //
  // type.addEntryType(luoValintaentryType("Kokoaa palapelejä",
  // "kuvaa psyykkistä kehitystä",
  // "Liikkuminen ja hahmottaminen", "päivähoito",
  // "päivähoidon asiakasrekisteri", "Päivähoito",
  // luovaluet("n.12", "n.20", ">20"),
  // luoTyypit(Constants.KEHITYSASIATYYPPI_ARVIO),
  // luoclassification(Constants.LUOKITUS_PSYYKKINEN_KEHITYS,
  // Constants.LUOKITUS_MOTORIIKKA_HIENO)));
  //
  // type.addEntryType(luoValintaentryType("Kätisyys",
  // "kuvaa fyysistä ja psyykkistä kehitystä",
  // "Liikkuminen ja hahmottaminen", "päivähoito",
  // "päivähoidon asiakasrekisteri", "Päivähoito",
  // luovaluet("Oikea", "Vasen", "Vaihtaen"),
  // luoTyypit(Constants.KEHITYSASIATYYPPI_ARVIO),
  // luoclassification(Constants.LUOKITUS_PSYYKKINEN_KEHITYS)));
  //
  // type.addEntryType(luoValintaentryType(
  ...
  // Constants.LUOKITUS_KIELI_JA_KOMMUNIKAATIO)));
  //
  // type.addEntryType(luoValintaentryType("Toimii ohjeiden mukaan",
  // "kuvaa vuorovaikutuksen ja kielen kehitystä",
  ...
  // "päivähoito",
  // "päivähoidon asiakasrekisteri", "Päivähoito", luovaluet("Yleensä",
  // "Vaihtelevasti", "Ei vielä"),
  // luoTyypit(Constants.KEHITYSASIATYYPPI_ARVIO),
  // luoclassification(Constants.LUOKITUS_MATEMAATTISET_TAIDOT)));
  //
  // type.addEntryType(luoValintaentryType("Tunnistaa ja nimeää perusvärit",
  // "kuvaa kielen kehitystä",
  // "Kieli ja kommunikaatio", "päivähoito", "päivähoidon asiakasrekisteri",
  // "Päivähoito",
  // luovaluet("Yleensä", "Vaihtelevasti", "Ei vielä"),
  ...
  // luoclassification(Constants.LUOKITUS_KIELI_JA_KOMMUNIKAATIO,
  // Constants.LUOKITUS_TARKKAAVAISUUS,
  // Constants.LUOKITUS_KESKITTYMINEN_JA_MUISTI,
  // Constants.LUOKITUS_PSYYKKINEN_KEHITYS)));
  //
  // type.addEntryType(luoVapaaTekstientryType(
  ...
  // luoTyypit(Constants.KEHITYSASIATYYPPI_HAVAINTO),
  // luoclassification(Constants.LUOKITUS_HUOLENAIHEET,
  // Constants.LUOKITUS_VAHVUUDET_JA_KIINNOSTUKSET,
  // Constants.LUOKITUS_LEIKKI,
  // Constants.LUOKITUS_SOSIAALISUUS_JA_TUNNEILMAISU)));
  //
  // type.addEntryType(luoVapaaTekstientryType(
  ...
  // Constants.LUOKITUS_SOSIAALISUUS_JA_TUNNEILMAISU)));
  //
  // type.addEntryType(luoVapaaTekstientryType("Terveiset neuvolaan",
  // "kerro terveiset neuvolaan", "", "päivähoito",
  // "päivähoidon asiakasrekisteri", "Päivähoito",
  // luoTyypit(Constants.KEHITYSASIATYYPPI_PALAUTE),
  // luoclassification(Constants.LUOKITUS_KOTI)));
  // }
  ...
  // }
  //
  // public static List<Classification> luoclassification(String...
  // classifications) {
  ...
  // }
  //
  // public static EntryType luoMonivalintaentryType(String kentta, String
  // classification, String ryhma,
  // String vastuutaho, String rekisteri, String tayttaja, List<String>
  // valueJoukko, List<Classification> tyypit,
  // List<Classification> classifications) {
  // codeGenerator++;
  //
  // EntryType type = new EntryType("" + codeGenerator, kentta, classification,
  // false, DataType.MULTI_SELECT,
  ...
  // }
  //
  // public static EntryType luoValintaentryType(String kentta, String
  // classification, String ryhma, String vastuutaho,
  // String rekisteri, String tayttaja, List<String> valueJoukko,
  // List<Classification> tyypit,
  // List<Classification> classifications) {
  // codeGenerator++;
  //
  // EntryType type = new EntryType("" + codeGenerator, kentta, classification,
  // false, DataType.SELECT, valueJoukko,
  ...
  // }
  //
  // public static EntryType luoVapaaTekstientryType(String kentta, String
  // classification, String ryhma,
  // String vastuutaho, String rekisteri, String tayttaja, List<Classification>
  // tyypit,
  // List<Classification> classifications) {
  // codeGenerator++;
  //
  // EntryType type = new EntryType("" + codeGenerator, kentta, classification,
  // false, DataType.FREE_TEXT, null,
  // vastuutaho, tayttaja, rekisteri, ryhma);
  //
  // type.setClassifications(classifications);
  // type.setDevelopmentTypes(tyypit);
  ...
  // }
  //
  // public static EntryType luoMonivalueinenVapaaTekstientryType(String kentta,
  // String classification, String ryhma,
  // String vastuutaho, String rekisteri, String tayttaja, String luontiMuoto,
  // List<Classification> tyypit,
  // List<Classification> classifications) {
  // codeGenerator++;
  //
  // EntryType type = new EntryType("" + codeGenerator, kentta, classification,
  // true, DataType.FREE_TEXT, null,
  // vastuutaho, tayttaja, rekisteri, ryhma);
  //
  // // type.setClassifications(classifications);
  // // type.setDevelopmentTypes(tyypit);
  ...
  // }
  //
  // public static EntryType luoTekstientryType(String kentta, String
  // classification, String ryhma, String vastuutaho,
  // String rekisteri, String tayttaja, List<Classification> tyypit,
  // List<Classification> classifications) {
  // codeGenerator++;
  //
  // EntryType type = new EntryType("" + codeGenerator, kentta, classification,
  // false, DataType.TEXT, null, vastuutaho,
  ...
  // return null;// new Entry(entry, new Date(), 1, t.getRegister(),
  // // "Kaisa Kirjaaja", t);
  // }
}
