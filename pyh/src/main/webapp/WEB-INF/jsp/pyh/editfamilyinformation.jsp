...
<div class="pyh-reset-floating"></div>
   ...
   <c:if test="${not empty messages}">
	...
	<c:if test="${childsGuardianshipInformationNotFound}">
		<p>Perheyhteyspyyntˆ‰ ei voida l‰hett‰‰!</p>
	</c:if>
...
<script type="text/javascript" language="JavaScript">
	...
	function doAddFamilyMemberConfirmation() {
		return confirm("Haluatko lis‰t‰ huollettavan lapsen perheenj‰seneksi?");
	}
	
	function doRemoveFamilyMemberConfirmation() {
		return confirm("Haluatko poistaa huollettavan lapsen perheenj‰senyyden?");
	}
