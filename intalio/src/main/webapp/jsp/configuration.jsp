...
<div class="configuration">
	...
	<c:choose>
		<c:when test="<%= portalInfo.equals(Constants.PORTAL_JBOSS) %>">
			 ...
			 <c:choose>	 
			 	<c:when test="<%= (isTaskIdEnabled == true) %>">
				...
				<c:otherwise>
					...
					<div class="FormValuesHelp">Lomakkeen sisältöä ei voi muuttaa täältä. Kirjaudu sisään
					admin tunnuksialla ja vaihda tämän instanssin 'showOnlyForm'-asetuksen arvo ylläolevan taulukon
					ID:llä.</div> 
