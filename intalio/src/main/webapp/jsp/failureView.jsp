...
<div class="portlet-linkit-container">		
	<div class="portlet-header">
		<div class="failureJsp">
			<div class="failureMessage firstMessage">Oops.. Jotain meni serverillä vikaan. Kokeile ladata sivu uudestaan ja yritä uudestaan tai ota yhtettä sivuston ylläpitäjään.</div>
