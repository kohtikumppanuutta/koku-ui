...
<div class="home">
	...
	<h1 class="portlet-section-header"><spring:message code="koku.lok.header.view"/></h1>
	
	
<div class="portlet-form-field">	
<div class="portlet-form-field-label"><spring:message code="koku.lok.search.for.view"/></div>	

<p>
  <form:form name="logSearchForm" commandName="logSearchCriteria" method="post" action="${viewActionUrl}">
